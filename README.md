...
- **強力なAIモデル対応**: GPT-5.4, Claude Opus 4.6, Gemini 3.1 Pro, Grok 4.1 など、2026年最新の高性能モデルをサポート
...
| プロバイダー | 推奨モデル | 特徴 |
| --- | --- | --- |
| **OpenAI** | **GPT-5.4 / 5.2 (Thinking)**<br>**GPT-5.1 / Mini / Nano**<br>**o3 Series** | 汎用性が高く、特に指示追従性能に優れています。<br>GPT-5.4/5.2は高度な推論とエージェント機能を備え、複雑な設定の整合性チェックや自動化ワークフローに最適です。 |
| **xAI (Grok)** | **Grok 4.1 Fast Reasoning**<br>**Grok 4.1 Fast / Grok 4 / 3**<br>**Grok Code Fast** | **[NEW]** 高速な推論と最大200万トークンのコンテキストが特徴。<br>ハルシネーションを低減した推論モデルは、長編プロット構築や深い分析に強力な威力を発揮します。 |
| **Anthropic** | **Claude Opus 4.6 / 4.5 / 4**<br>**Claude Sonnet 4.6 / 4.5** | 自然で文学的な日本語表現と、長文入力時の高い安定性を誇ります。<br>2026年最新のOpus 4.6は推論とエージェント機能がさらに強化されており、繊細な感情描写に定評があります。 |
| **Google** | **Gemini 3.1 Pro / Flash**<br>**Gemini 3.0 Pro / Flash**<br>**Gemini 2.5 Pro / Flash** | マルチモーダル（画像・音声・動画・PDF）処理能力が最強。最大200万トークンの長大なコンテキストに対応。<br>大量の資料読み込みや、メディアミックス的な創作活動に適しています。 |
