...
A: 以下の点を確認してください：
1. ローカルLLMサーバーが起動しているか
2. インターネット接続（クラウドAI使用時）
3. プロンプトが適切か
4. モデルの性能
...
A: ローカルLLMを使用する場合、完全にオフラインで使用できます。クラウドAIを使用する場合は、インターネット接続が必要です。

---

**サポートが必要な場合は、[GitHub Issues](https://github.com/your-username/ai-story-builder/issues)でお気軽にお問い合わせください。**
