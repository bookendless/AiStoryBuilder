    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          '※ 画像から物語を作る機能は、クラウドAI（OpenAI/Claude/Gemini/Grok）または画像解析対応のローカルLLM（Ollama、LM Studioなど）で利用できます',
          '※ 音声から物語を作る機能は、Gemini 3系またはOpenAIのモデルが必要です',
        ],
    ...
    sections: [
      {
        ...
        content: [
          ...
          '約500文字が目標です（現在の文字数と目安はエディタに表示されます）',
          '生成結果を確認して、必要に応じて編集',
        ],
    ...
    sections: [
      {
        ...
        content: [
          ...
          '評価対象（あらすじ、章、作品全体、カスタムテキスト、外部ファイル）を選択して、各モードで評価を実行',
          '4段階の厳しさ（やさしい・普通・厳しい・辛辣）から評価のトーンを選べます',
    ...
    sections: [
      {
        ...
        content: [
          ...
          'Markdown形式（.md）',
          'HTML形式（.html）',
          'プロジェクト全体のバックアップ（JSON）※ホーム画面のエクスポート機能',
        ],
