    ...
    >
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors font-['Noto_Sans_JP'] ${
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          {/* 追加/編集フォーム */}
          {showAddForm && (
            <div className="w-96 border-l border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 overflow-y-auto">
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors font-['Noto_Sans_JP'] ${
                        aiMode === 'generate'
