...
知識の変化: [この章の終わりに誰が何を知り、誰が何を知らないままか]
伏線: [この章で張る・仄めかす・回収する伏線。無ければ「なし」]
...
【出力制約】
- 最低4章以上作成すること
- 各章は必ず上記の8項目（章タイトル、概要、設定・場所、雰囲気・ムード、重要な出来事、登場キャラクター、知識の変化、伏線）を含むこと
- 「知識の変化」は出来事の言い換えにせず、登場人物の認識がどう変わるかを書くこと（例: 主人公は父の裏切りを知るが、妹には伏せたまま）
- 「伏線」は張る／仄めかす／回収するのどれかを明示すること（例: 回収＝第2章の指輪の出所が判明する）
